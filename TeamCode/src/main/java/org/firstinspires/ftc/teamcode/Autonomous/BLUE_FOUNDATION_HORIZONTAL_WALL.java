...
@Autonomous(name = "BLUE_FOUNDATION_HORIZONTAL_WALL", group = "Autonomous")
public class BLUE_FOUNDATION_HORIZONTAL_WALL extends LinearOpMode {
    ...
    public void runOpMode() {
        auto = new DWAIAutonomous(PLATFORM_ORIENTATION.HORIZONTAL, PARK_POSITION.WALL, SIDE.FOUNDATION, ALLIANCE.BLUE, this);
        auto.runOpMode();
    }

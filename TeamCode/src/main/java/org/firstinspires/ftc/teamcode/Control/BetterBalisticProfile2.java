...
public class BetterBalisticProfile2 {
    ...
    public double getCurrent_Power(){
        boolean accelerating = abs(start_position - current_position) < acceleration_distance;
        boolean decelerating = abs(end_position - current_position) < deceleration_distance;
    ...
    public enum CURVE_TYPE {
        LINEAR, SINUSOIDAL_NORMAL, SINUSOIDAL_INVERTED, SINUSOIDAL_SCURVE
    }
}

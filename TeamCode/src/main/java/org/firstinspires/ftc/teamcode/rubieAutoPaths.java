...
public class rubieAutoPaths extends LinearOpMode {
    ...
    *Nothing* - Can be accessed from within the package (package private)
    ...
    public void runOpMode() {
        ...
        robotLinearOpMode.moveByInches(-36, RobotLinearOpMode.MOVEMENT_DIRECTION.STRAFE,true);
        ...
        robotLinearOpMode.moveByInches(18, RobotLinearOpMode.MOVEMENT_DIRECTION.STRAFE,true);

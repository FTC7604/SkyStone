...
@Autonomous(name = "Blue Block Vertical Wall", group = "Autonomous")
@Disabled
public class BLUE_BLOCK_VERTICAL_WALL extends LinearOpMode {
    private DWAIAutonomous auto;

    @Override
    public void runOpMode() {
        auto = new DWAIAutonomous(FOUNDATION_ORIENTATION.VERTICAL, PARK_POSITION.WALL, SIDE.BLOCK, ALLIANCE.BLUE, this);
        auto.runOpMode();
    }
